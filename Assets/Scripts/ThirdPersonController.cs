...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public int greenCrystalsObtained = 0;
        ...
        public UnityEngine.UI.Image saturationBar;
        ...
        public void ManaUpdate()
        {
            ...
            saturationBar.fillAmount = saturation / 100;
        ...
        {
            greenCrystalsObtained += 1;
            //Debug.Log(greenCrystalsObtained);
            if (greenCrystalsObtained == 2)
            {
                //Debug.Log("I'm not insane");
